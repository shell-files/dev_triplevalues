...
const HeaderNav = ({ 
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 fixed top-0 left-0 right-0 z-40">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-2.5 py-1.5">
          ...
          <select 
            ...
            className="text-xs font-bold text-gray-800 bg-transparent border-none outline-none cursor-pointer focus:ring-0"
          >
        ...
        <div className="flex items-center gap-2 border-l border-gray-200 pl-4">
          <div className="w-8 h-8 rounded-full bg-[#03a94d] text-white flex items-center justify-center text-xs font-bold shadow-sm">
            M
          </div>
