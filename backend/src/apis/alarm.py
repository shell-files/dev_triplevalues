...
from src.models.alarm import getAlarmListProcess, readAlarmProcess, deleteAlarmProcess, sendAlarmProcess, readAlarmReqProcess
from src.models.model import alarmResponse, alarmListModel, alarmReadModel, alarmSendModel, alarmReadReqModel, responseModel
...
def patchAlarm(
    request: Request,
    alarmReadModel : alarmReadReqModel
):
    return readAlarmReqProcess(request, alarmReadModel)
...
def patchAlarm(
    ...
    return readAlarmReqProcess(request, alarmReadModel, False)
