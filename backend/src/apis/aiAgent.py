...
from src.models.aiagent import (
...
@router.get("/dashboard/alerts",
            summary="AI 대시보드 alerts",
            description="대시보드 alertas 조회")
def getDashboardAlerts(params: dashboardAlertsRiskModel= Depends()):
    return getDashboardAlertsProcess(params)

@router.get("/dashboard/alerts/{alertId}",
            summary="AI Agent 알림 상세 조회",
            description="특정 alert_id에 대한 상세 데이터 조회")
...
@router.post("/dashboard/alerts/{alertId}/resolve")
